...
KEFKAS_TOWER_MIDDLE_STATUE = NameBit("KT Mid Triad Statue", event_bit.DEFEATED_POLTERGEIST, None, None)
KEFKAS_TOWER_RIGHT_STATUE = NameBit("KT Right Triad Statue", event_bit.DEFEATED_GODDESS, None, None)
