...
check_bit = [
    ...
    checks.ZONE_EATER,
    checks.ZOZO_TOWER,
    checks.KEFKAS_TOWER_AMBUSH,
    checks.KEFKAS_TOWER_GUARDIAN,
    checks.KEFKAS_TOWER_LEFT_STATUE,
    checks.KEFKAS_TOWER_MIDDLE_STATUE,
    checks.KEFKAS_TOWER_RIGHT_STATUE,
    checks.NARSHE_MOOGLE_DEFENSE,
    checks.AUCTION1,
    checks.AUCTION2,
]
...
quest_bit = [
    ...
    quests.DEFEATED_INFERNO,
    quests.DEFEATED_GUARDIAN,
