...
DEFEATED_INFERNO = NameBit("Defeat KT Ambusher", event_bit.DEFEATED_INFERNO)
DEFEATED_GUARDIAN = NameBit("Defeat KT Robot", event_bit.DEFEATED_GUARDIAN)
DEFEATED_DOOM = NameBit("Defeat KT Left Statue", event_bit.DEFEATED_DOOM)
DEFEATED_POLTERGEIST = NameBit("Defeat KT Mid Statue", event_bit.DEFEATED_POLTERGEIST)
DEFEATED_GODDESS = NameBit("Defeat KT Right Statue", event_bit.DEFEATED_GODDESS)
