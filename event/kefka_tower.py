...
class KefkaTower(Event):
    ...
    def entrance_landing_mod(self):
        ...
        space.write(
            ...
            field.DialogBranch(gauntlet_entrance,
                            dest1 = "GAUNTLET_LANDING",  dest2 = "CANCEL_LANDING", dest3 = "CANCEL_LANDING"),
            "STATUES_DIALOG",
    ...
    def gauntlet_guardian_cutscene(self):
        src = [
            ...
            # Phase 1: position all 3 parties up front, while the screen is
            # still held/black. Each SetPosition is synchronous
            # (wait_until_complete = True) so this is safe - no movement
            # scripts are dispatched yet, so there's nothing for a later
            # change_party() to corrupt.
            ...
            # switch between parties and trigger their animations
            change_party(1),
